...
6. :eight_spoked_asterisk: [Running MAX Deep Learning models on Raspberry Pi](https://developer.ibm.com/technologies/artificial-intelligence/blogs/running-max-deep-learning-models-on-raspberry-pi)
